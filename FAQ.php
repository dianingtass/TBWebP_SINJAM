...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
                    ...
                    <div class="accordion" id="accordion-bs">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#accordion-bs">
                                <div class="accordion-body">
                                    ...
                                    &emsp;&emsp;1. Mahasiswa diperbolehkan untuk melakukan pengajuan peminjaman fasilitas pada hari <strong>Senin - Sabtu</strong> di antara pukul <strong>08.00 - 16.00 WIB</strong>. <br>&emsp;&emsp;2. Harap fasilitas ditinggalkan dengan keadaan seperti semula. <br>&emsp;&emsp;3. <strong>Tidak boleh</strong> melebihi batas waktu yang telah diajukan. <br>&emsp;&emsp;4. <strong>Tidak boleh</strong> merusak dan menghilangkan properti fasilitas. <br></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                ...
                                Q : Bagaimana cara untuk mengecek ketersediaan tanggal pada fasilitas yang ingin diajukan peminjaman?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">Q : Siapa yang berhak dan tidak berhak dalam melakukan pengajuan peminjaman fasilitas UPNVJ?
                                </button>
                            </h2>
		...
		<footer id="footer-sec" class="footer-section">
