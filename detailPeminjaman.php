  ...
  <div class="container relative">
    <div class="row">
      <div class="col-4 mt-5">
        <a href="managePeminjaman.php" style="font-weight: 650; font-size: 32px; color:#208aae" class="logo-link">SINJAM<span style="font-weight:100; color: black;">UPNVJ</span></a>
      </div>
      <div class="col-4">
